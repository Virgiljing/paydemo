...
import com.sihai.unionpay.AcpService;
import com.sihai.unionpay.DemoBase;
import com.sihai.unionpay.LogUtil;
...
import static com.sihai.unionpay.AcpService.sign;
...
public class UnionPayServiceImpl implements UnionPayService {
    ...
    public String pay(HttpServletRequest req, HttpServletResponse resp)
        ...
        /***商户接入参数***/
        requestData.put("merId", "777290058164706");    	          			  //商户号码，请改成自己申请的正式商户号或者open上注册得来的777测试商户号
        ...
        requestData.put("txnAmt", "1234");             			      //交易金额，单位分，不要带小数点
        ...
        LogUtil.writeLog("------------------------"+sid.nextShort());
