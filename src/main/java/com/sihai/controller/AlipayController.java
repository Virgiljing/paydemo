...
import com.alipay.api.request.AlipayAccountExrateAdviceAcceptRequest;
...
public class AlipayController {
	...
	public String goAlipay(String orderId, HttpServletRequest request, HttpServletRequest response) throws Exception {
		...
		//商品描述，可空
		String body = "测试:" + order.getBuyCounts();

        System.out.println(orderId+subject+body+subject);
...
//				+ "\"product_code\":\"FAST_INSTANT_TRADE_PAY\"}");
        ...
        AlipayTradePrecreateResponse response1 = alipayClient.execute(request1);
        System.out.println("#####################################");
        System.out.print(response1.getBody());
        System.out.print(response1.getQrCode());
        System.out.println("#####################################");


        System.out.println("response1:############"+payResponse.isSuccess());



        System.out.println("body1##################"+payResponse.getBody()+":#############"+payResponse.getCode());
